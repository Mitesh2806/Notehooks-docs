...
Installing notehooks is simple and straightforward. The package is available on npm and can be installed using any package manager. noteHooks works with [React](https://reactjs.org/) version 16.8 or higher (hooks support required).
