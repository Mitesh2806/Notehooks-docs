...
const Usage = () => {
  return (
    <section className="w-full border-b border-border border-dashed bg-secondary/20">
      <div className="max-w-6xl mx-auto border-x border-border border-dashed p-6 py-24">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          
          {/* Text Content */}
          <div>
            <h2 className="text-4xl font-bold mb-6 tracking-tight">Simple. Powerful. Elegant.</h2>
            ...
            <div className="space-y-3">
              {['useDebounce', 'useLocalStorage', 'useMediaQuery', 'useOnClickOutside'].map((hook) => (
                <div key={hook} className="flex items-center gap-3 group">
                  ...
                  <code className="text-sm font-mono bg-secondary border border-border px-2 py-1 rounded text-secondary-foreground">
                    {hook}
                  </code>
                </div>
              ))}
          ...
          <div className="relative">
             ...
             <div className="relative bg-card rounded-xl border border-dashed border-border overflow-hidden">
                <div className="flex items-center gap-2 px-4 py-3 border-b border-dashed border-border bg-muted/50">
                  <div className="w-2.5 h-2.5 rounded-full bg-red-400/80"></div>
                  <div className="w-2.5 h-2.5 rounded-full bg-yellow-400/80"></div>
                  <div className="w-2.5 h-2.5 rounded-full bg-green-400/80"></div>
                  <span className="ml-2 text-xs text-muted-foreground font-mono">Example.tsx</span>
                </div>
                <div className="p-6 overflow-x-auto bg-[#0a0a0a] dark:bg-[#0a0a0a]">
